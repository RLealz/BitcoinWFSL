        ...
        <div className="container mx-auto px-4">
          ...
          <section id="plans" className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-2 border-[#CD7F32] hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  <CardTitle className="text-[#CD7F32] text-2xl">Bronze</CardTitle>
                  <CardDescription>€1.000 - €2.500</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <div className="text-3xl font-bold text-[#CD7F32] mb-2">4.17%</div>
                  <div className="text-sm text-gray-600 mb-4">por mês (50% ao ano)</div>
              ...
              <Card className="border-2 border-[#C0C0C0] hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  <CardTitle className="text-[#C0C0C0] text-2xl">Prata</CardTitle>
                  <CardDescription>€2.500 - €5.000</CardDescription>
                </CardHeader>
                <CardContent className="text-center">
                  <div className="text-3xl font-bold text-[#C0C0C0] mb-2">6.25%</div>
                  <div className="text-sm text-gray-600 mb-4">por mês (75% ao ano)</div>
                  <ul className="text-sm text-gray-600 space-y-2">
              ...
              <Card className="border-2 border-[#FFD700] hover:shadow-lg transition-shadow">
                ...
                <CardContent className="text-center">
                  ...
                  <div className="text-sm text-gray-600 mb-4">por mês (100% ao ano)</div>
                  <ul className="text-sm text-gray-600 space-y-2">
